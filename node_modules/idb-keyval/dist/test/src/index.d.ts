export declare function promisifyRequest<T = undefined>(
 ...
 * @param customStore Method to get a custom store. Use with caution (see the docs).
 */
export declare function setMany(
 ...
 * @param customStore Method to get a custom store. Use with caution (see the docs).
 */
export declare function getMany<T = any>(
  keys: IDBValidKey[],
  customStore?: UseStore,
): Promise<T[]>;
/**
 ...
 * @param customStore Method to get a custom store. Use with caution (see the docs).
 */
export declare function delMany(
  keys: IDBValidKey[],
  customStore?: UseStore,
): Promise<void>;
/**
 ...
 * @param customStore Method to get a custom store. Use with caution (see the docs).
 */
export declare function keys<KeyType extends IDBValidKey>(
  customStore?: UseStore,
): Promise<KeyType[]>;
/**
